<center><font size='6'>Linux内核深入理解中断和异常（7）：中断下半部：Softirq, Tasklets and Workqueues</font></center>
<br/>
<br/>
...
![run_ksoftirqd()](_v_images/20210325164540770_11549.png)
...
* tasklets运行在软件中断上下文中；
* `ksoftirqd`调度 `softirqs`
* `kworker`调度`workqueue`
...
* 来自`do_IRQ()`，在5.10.13中为`common_interrupt`；
* 
...
> 5.10.13中没有了`tasklet_hi_schedule_first`。
